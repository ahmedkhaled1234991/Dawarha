      ...
      body: Stack(
        children: [
          Container(
              ...
              color: Colors.white,
              child: CustomPaint(
                size: Size(SizeConfig.screenWidth / 1.6,(SizeConfig.screenWidth / 1.6 *1).toDouble()),
          ...
          Scaffold(
              ...
              appBar: AppBar(
                backgroundColor: Colors.transparent,
                elevation: 0,
                iconTheme: IconThemeData(color: Colors.black, size: SizeConfig.screenWidth / 13.714),
              ),
              ...
              body: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.symmetric(vertical: SizeConfig.screenHeight / 46.9333),
                        child: slider(),
                      ),
                      Padding(
                      ...
                      SizedBox(height: SizeConfig.screenHeight / 64.9333,),
                      Directionality(
      ...
      child: SizedBox(
        ...
        child: Drawer(
          ...
          child: ListView(
            ...
            children: [
              SizedBox(
                height: SizeConfig.screenHeight / 4.267,
                child: Card(
              ...
              ListTile(
                leading: Icon(Icons.notifications, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'الاشعارات',
                  style: TextStyle(
                    color: Colors.black,
              ...
              ListTile(
                leading: Icon(Icons.settings, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'تعديل الملف الشخصى',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.book, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'دليل المستخدم',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.question_answer, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'الأسئلة الشائعة',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.announcement, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'اخبرنا رأيك',
                  style: TextStyle(
                    color: Colors.black,
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) {
                    return TellUsYourOpinionScreen(screenNavigateFrom: 'Home screen');
                  }));
                },
              ),
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: SvgPicture.asset("assets/icons/Contact_icon.svg", width: SizeConfig.screenWidth / 16,),
                title: Text(
                  'تواصل معنا',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.translate, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'تغيير اللغة',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.security, color: AppColors.greenColor, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'سياسة الخصوصية',
                  style: TextStyle(
                    color: Colors.black,
              ...
              SizedBox(height: SizeConfig.screenHeight / 62.578,),
              ListTile(
                leading: Icon(Icons.logout, color: Colors.red, size: SizeConfig.screenWidth / 16,),
                title: Text(
                  'تسجيل الخروج',
                  style: TextStyle(
                    color: Colors.black,
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Padding(
            padding: EdgeInsets.symmetric(horizontal: SizeConfig.screenWidth / 48),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              ...
              children: [
                CircleAvatar(
                  ...
                  child: SizedBox(
                      ...
                      child: Image.asset("assets/images/Nestle_image.png", fit: BoxFit.cover,)),
                ),
                SizedBox(height: SizeConfig.screenHeight / 93.867,),
...
class RPSCustomPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path0.quadraticBezierTo(size.width*0.5482000,size.height*0.0976000,size.width*0.6864000,size.height*0.1228000);
    path0.quadraticBezierTo(size.width*0.7684000,size.height*0.1366000,size.width,size.height*0.1444000);
    path0.close();
